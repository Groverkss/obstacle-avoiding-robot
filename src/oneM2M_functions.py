...
def create_subscription(uri_cnt, value, cin_labels="", data_format="json"):
    """
        Method description:
        Deletes/Unregisters an application entity(AE) from the OneM2M framework/tree
        under the specified CSE
...
if __name__ == "__main__":
    ...
    create_data_cin(uri_cnt, value, cin_labels=["label-1","label-2"], data_format="json")

    create_subscription(uri_cnt,value,cin_labels=["label-1","label-2"], data_format="json")
